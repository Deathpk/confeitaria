...
import TestimonalsPagination from "../components/TesmimonalsPagination";
import {paginate} from '../helpers/paginate';

const Testimonals = () => {
    const [currentPage, setCurrentPage] = useState(1);
    const pageSize = 2;
    const currentTestimonals = paginate(Testimonials, currentPage, pageSize);
        ...
        <div id="testimonials">
            ...
            <section className="my-8">
                <div className="container mx-auto grid grid-cols-1 gap-8 lg:gap-20 md:px-10 md:pb-10 lg:grid-cols-2">
                    {
                        currentTestimonals.map( (testimonial, index) => {
                            return(
                                <div key={index} className="flex flex-col items-center mx-12 lg:mx-0">
                                    <div className="relative text-center">
                                        ...
                                        <p className="px-12 py-1 text-lg text-black italic">{testimonial.testimonial}</p>
