...
const ContactMe = () => {
    ...
    return (
        <div className="mt-5" id="contacte-me">
            <h1 className="flex justify-center text-black font-bold md:text-6xl text-5xl cursive-title">Não encontrou oque procurava</h1>
            <h1 className="flex justify-center text-black font-bold md:text-6xl text-5xl cursive-title mb-10">ou tem algo especial em mente?</h1>
